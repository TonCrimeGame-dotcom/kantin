...
const MODE_SEATS=Object.freeze({spvp:['white','black'],upvp:['A1','B1','A2','B2'],pistiSolo:['P1','P2'],pistiTeam:['A1','B1','A2','B2'],okeyClassic:['P1','P2','P3','P4'],okeySolo:['P1','P2','P3','P4'],okeyTeam:['A1','B1','A2','B2'],batakKozMaca:['P1','P2','P3','P4'],batakGommeli:['P1','P2','P3'],sozcukDuel:['P1','P2','P3','P4']});
