(() => {
  ...
  const modeLabel = mode => ({ spvp: 'Klasik Tavla', upvp: 'Üniversite Tavlası', pistiSolo: 'Pişti', pistiTeam: 'Eşli Pişti', okeyClassic: 'Klasik Okey', okeySolo: '101 Okey', okeyTeam: 'Eşli 101', sozcukDuel: 'Sözcük Kapışması' })[mode] || mode;
