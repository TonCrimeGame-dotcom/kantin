(() => {
  ...
  const en = {
    ...
    'game.batak': 'Batak',
    'game.batakSubtitle': 'Select trump, collect tricks',
    ...
    'mode.batakKozMaca': 'Spades Trump',
    'mode.batakGommeli': 'Blind Penalty',
    ...
    'desc.batakKozMaca': 'Spades always trump',
    'desc.batakGommeli': '100 penalty for missing bid',
  ...
  const tr = {
    ...
    'game.backgammon':'Tavla','game.backgammonSubtitle':'Zarını at, masayı kap','game.pisti':'Pişti','game.pistiSubtitle':'Kartını oyna, desteyi topla','game.okey':'101 Okey','game.okeySubtitle':'Perini aç, elini bitir','game.batak':'Batak','game.batakSubtitle':'Kozunu seç, elleri topla','game.word':'Sözcük Kapışması','game.wordSubtitle':'Harfini koy, sözcüğünü kur','mode.backgammon':'Klasik Tavla','mode.university':'Üniversite Tavlası','mode.pistiSolo':'Klasik Pişti','mode.pistiTeam':'Eşli Pişti','mode.okeySolo':'Bireysel 101','mode.okeyTeam':'Eşli 101','mode.batakKozMaca':'Koz Maça','mode.batakGommeli':'Gömmeli','mode.word':'Sözcük Kapışması','mode.fourPlayers':'4 kişi','mode.fourSolo':'4 kişi · herkes tek',
    'desc.backgammon':'Klasik 15 pullu tavla','desc.university':'Aynı zar, iki bağımsız tahta','desc.pistiSolo':'Hızlı ve rekabetçi','desc.pistiTeam':'Eşinle puanları birleştir','desc.okeySolo':'101 aç, elini bitir','desc.okeyTeam':'Karşılıklı eşlerle takım oyunu','desc.batakKozMaca':'Koz her zaman maça olur','desc.batakGommeli':'Görmeyen 100 puan yazar','desc.word':'Dört oyuncu, herkes kendi puanına oynar',
  ...
  const ru = {
    ...
    'desc.backgammon':'Классические нарды с 15 шашками','desc.university':'Те же кости, две независимые доски','desc.pistiSolo':'Быстро и конкурентно','desc.pistiTeam':'Объедините очки с партнёром','desc.okeySolo':'Откройте на 101 и завершите руку','desc.okeyTeam':'Команды сидят напротив друг друга','desc.batakKozMaca':'Пики всегда козырь','desc.batakGommeli':'100 штраф за не открыв','desc.word':'Четыре игрока, каждый играет за свой счёт',
  ...
  const es = {
    ...
    'game.backgammon':'Backgammon','game.backgammonSubtitle':'Lanza los dados y cierra el tablero','game.pisti':'Pişti','game.pistiSubtitle':'Juega una carta y recoge la baraja','game.okey':'Okey 101','game.okeySubtitle':'Abre combinaciones y termina tu mano','game.batak':'Batak','game.batakSubtitle':'Elige el triunfo, recoge las bazas','game.word':'Duelo de Palabras','game.wordSubtitle':'Coloca letras y forma palabras','mode.backgammon':'Backgammon clásico','mode.university':'Backgammon universitario','mode.pistiSolo':'Pişti clásico','mode.pistiTeam':'Pişti por equipos','mode.okeySolo':'101 individual','mode.okeyTeam':'101 por equipos','mode.batakKozMaca':'Triunfo picas','mode.batakGommeli':'Penalización ciega','mode.word':'Duelo de Palabras','mode.fourPlayers':'4 jugadores','mode.fourSolo':'4 jugadores · individual',
    ...
    'desc.backgammon':'Backgammon clásico con 15 fichas','desc.university':'Los mismos dados, dos tableros independientes','desc.pistiSolo':'Rápido y competitivo','desc.pistiTeam':'Combina puntos con tu compañero','desc.okeySolo':'Abre a 101 y termina tu mano','desc.okeyTeam':'Los equipos se sientan frente a frente','desc.batakKozMaca':'Picas siempre es triunfo','desc.batakGommeli':'100 de penalización por no ver','desc.word':'Cuatro jugadores, cada uno juega por su propia puntuación',
  ...
  const hi = {
    ...
    'game.backgammon':'बैकगैमौन','game.backgammonSubtitle':'पासा फेंकें और बोर्ड बंद करें','game.pisti':'Pişti','game.pistiSubtitle':'कार्ड खेलें और डेक जमा करें','game.okey':'101 Okey','game.okeySubtitle':'मेल्ड खोलें और हाथ पूरा करें','game.batak':'बटक','game.batakSubtitle':'तुरफ चुनें, बाज़ी जमा करें','game.word':'शब्द मुकाबला','game.wordSubtitle':'अक्षर रखें और शब्द बनाएँ','mode.backgammon':'क्लासिक बैकगैमौन','mode.university':'यूनिवर्सिटी बैकगैमौन','mode.pistiSolo':'क्लासिक Pişti','mode.pistiTeam':'टीम Pişti','mode.okeySolo':'व्यक्तिगत 101','mode.okeyTeam':'टीम 101','mode.batakKozMaca':'तुरफ पिकास','mode.batakGommeli':'अंधा दंड','mode.word':'शब्द मुकाबला','mode.fourPlayers':'4 खिलाड़ी','mode.fourSolo':'4 खिलाड़ी · सभी अलग',
    ...
    'desc.backgammon':'क्लासिक 15 शीट वाला बैकगैमौन','desc.university':'वही पासा, दो स्वतंत्र बोर्ड','desc.pistiSolo':'तेज और प्रतिस्पर्धी','desc.pistiTeam':'साथी के साथ अंक जोड़ें','desc.okeySolo':'101 पर खोलें और हाथ पूरा करें','desc.okeyTeam':'टीमें एक-दूसरे के सामने बैठती हैं','desc.batakKozMaca':'पिकास हमेशा तुरफ होता है','desc.batakGommeli':'न देखने पर 100 दंड','desc.word':'चार खिलाड़ी, हर कोई अपने अंक के लिए खेलता है',
  ...
  const de = {
    ...
    'game.backgammon':'Backgammon','game.backgammonSubtitle':'Würfle und räume das Brett','game.pisti':'Pişti','game.pistiSubtitle':'Spiele eine Karte und sammle den Stapel','game.okey':'Okey 101','game.okeySubtitle':'Lege deine Kombinationen aus und beende die Hand','game.batak':'Batak','game.batakSubtitle':'Wähle Trumpf, sammle Stiche','game.word':'Wortduell','game.wordSubtitle':'Lege Buchstaben und bilde Wörter','mode.backgammon':'Klassisches Backgammon','mode.university':'Universitäts-Backgammon','mode.pistiSolo':'Klassisches Pişti','mode.pistiTeam':'Team-Pişti','mode.okeySolo':'101 Einzel','mode.okeyTeam':'101 Team','mode.batakKozMaca':'Pik Trumpf','mode.batakGommeli':'Blindstrafe','mode.word':'Wortduell','mode.fourPlayers':'4 Spieler','mode.fourSolo':'4 Spieler · jeder für sich',
    ...
    'desc.backgammon':'Klassisches Backgammon mit 15 Steinen','desc.university':'Die gleichen Würfel, zwei unabhängige Bretter','desc.pistiSolo':'Schnell und wettbewerbsfähig','desc.pistiTeam':'Verbinde Punkte mit deinem Partner','desc.okeySolo':'Öffne bei 101 und beende deine Hand','desc.okeyTeam':'Teams sitzen sich gegenüber','desc.batakKozMaca':'Pik ist immer Trumpf','desc.batakGommeli':'100 Strafe für nicht gesehen','desc.word':'Vier Spieler, jeder spielt für seine eigene Punktzahl',
  ...
  const ar = {
    ...
    'game.backgammon':'الطاولة','game.backgammonSubtitle':'ارمِ النرد وأغلق اللوح','game.pisti':'Pişti','game.pistiSubtitle':'العب بطاقة واجمع الرزمة','game.okey':'أوكي 101','game.okeySubtitle':'افتح مجموعاتك وأنهِ يدك','game.batak':'بطةك','game.batakSubtitle':'اختر الترومب واجمع العروق','game.word':'تحدي الكلمات','game.wordSubtitle':'ضع حرفًا وكوّن كلمة','mode.backgammon':'الطاولة الكلاسيكية','mode.university':'طاولة الجامعة','mode.pistiSolo':'Pişti الكلاسيكية','mode.pistiTeam':'Pişti جماعية','mode.okeySolo':'101 فردي','mode.okeyTeam':'101 جماعي','mode.batakKozMaca':'ترومب بسباد','mode.batakGommeli':'عقوبة العمى','mode.word':'تحدي الكلمات','mode.fourPlayers':'4 لاعبين','mode.fourSolo':'4 لاعبين · كل لاعب لنفسه',
    'desc.backgammon':'الطاولة الكلاسيكية بـ 15 قطعة','desc.university':'النرد نفسه، لوحان مستقلان','desc.pistiSolo':'سريع وتنافسي','desc.pistiTeam':'اجمع النقاط مع شريكك','desc.okeySolo':'افتح عند 101 وأنهِ يدك','desc.okeyTeam':'الفريقان يجلسان مقابل بعضهما','desc.batakKozMaca':'البسباد دائمًا ترومب','desc.batakGommeli':'100 عقوبة لعدم الرؤية','desc.word':'أربعة لاعبين، كل يلعب لصالحه',
